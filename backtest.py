...
DISPERSION        = 1.00            # NB overdispersion factor — matches production.
                                    # Reverted from 1.45 after a dedicated scoreline-
                                    # distribution calibration harness showed exact-score
                                    # log-loss/Brier both improve monotonically toward 1.0,
                                    # RPS flat. At dispersion=1.00 the NB collapses exactly
                                    # to bivariate Poisson.
